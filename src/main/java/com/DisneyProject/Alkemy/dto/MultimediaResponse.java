...
public class MultimediaResponse {
    ...
    private List<MultimediaDto> contenido;
    ...
    public List<MultimediaDto> getContenido() {
        return contenido;
    }

    public void setContenido(List<MultimediaDto> contenido) {
